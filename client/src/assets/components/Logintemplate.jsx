    ...
    return (
        <div className={'md:flex w-1/2 '}>
            <div className={'z-10 absolute '}>
                <img src={assets.BackgroundImage2} className={' min-h-screen  w-full md:w-1/2  object-fill'}  alt={'login background'}/>
            </div>
            <div className='hidden md:flex  relative overflow-hidden border-r border-slate-200'>
